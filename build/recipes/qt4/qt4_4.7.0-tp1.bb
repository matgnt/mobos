...
SRC_URI = "\
	http://get.qt.nokia.com/qt/source/qt-everywhere-opensource-src-4.7.0-tp.tar.gz \
	file://0001-cross-compile.patch;patch=1 \
	file://0001-Disable-qmlviewer-qml.patch;patch=1 \
...
S = "${WORKDIR}/qt-everywhere-opensource-src-4.7.0-tp"
